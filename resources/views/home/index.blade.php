...
<div class="super_container">
	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-6992px, 0px, 0px); transition: all 0s ease 0s; width: 12236px;"><div class="owl-item cloned" style="width: 1748px;"><div class="owl-item home_slider_item">
				...
				</div></div><div class="owl-item cloned" style="width: 1748px;"><div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/home_slider_1.jpg)"></div>
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content animated animate-out fadeOut fadeIn" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">A new Online Shop experience.</div>
										<div class="home_slider_subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ultricies metus. Sed nec molestie eros. Sed viverra velit venenatis fermentum luctus.</div>
										<div class="button button_light home_button"><a href="#">Shop Now</a></div>
									</div>
				...
				</div></div><div class="owl-item" style="width: 1748px;"><div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/home_slider_1.jpg)"></div>
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
				...
				</div></div><div class="owl-item active" style="width: 1748px;"><div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/home_slider_1.jpg)"></div>
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<div class="product_grid" style="position: relative; height: 402px;">
						...
						<!-- Product -->
						<div class="product" style="position: absolute; left: 585px; top: 0px;">
						...
						<!-- Product -->
						<div class="product" style="position: absolute; left: 877px; top: 0px;">
						...
						<!-- Product -->
						<div class="product" style="position: absolute; left: 0px; top: 201px;">
						...
						<!-- Product -->
						<div class="product" style="position: absolute; left: 292px; top: 201px;">
						...
						<!-- Product -->
						<div class="product" style="position: absolute; left: 585px; top: 201px;">
						...
						<!-- Product -->
						<div class="product" style="position: absolute; left: 877px; top: 201px;">
